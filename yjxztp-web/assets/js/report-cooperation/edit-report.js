layui
  ...
  .use(["dropDown", "layer", "tree", "colorpicker"], function () {
        ...
        choose: function (data) {
          ...
          if (data.type === 1) {
            ...
            layer.open({
              ...
              shade: 0.001,
              skin:
                "taolun-layer layui-anim layui-anim-rl layui-layer-openRight",
              area: "400px",
              zIndex: "99",
              content: taolunEle,
              move: false,
            ...
            layer.open({
              ...
              shade: 0.001,
              skin:
                "taolunjilu-layer layui-anim layui-anim-rl layui-layer-openRight",
              area: "400px",
              zIndex: "99",
              content: ele,
              move: false,
          ...
          if (data.type === 3) {
            ...
            layer.open({
              ...
              shade: 0.001,
              skin:
                "pinglun-layer layui-anim layui-anim-rl layui-layer-openRight",
              area: "400px",
              zIndex: "99",
              content: ele,
              move: false,
            ...
            layer.open({
              ...
              shade: 0.001,
              skin:
                "member-layer layui-anim layui-anim-rl layui-layer-openRight",
              area: "400px",
              zIndex: "99",
              content: taskLayer,
              move: false,
            ...
            layer.open({
              ...
              shade: 0.001,
              skin:
                "version-layer layui-anim layui-anim-rl layui-layer-openRight",
              area: "400px",
              zIndex: "99",
              content: memberLayer,
              move: false,
            ...
            layer.open({
              ...
              shade: 0.001,
              skin:
                "paiban-layer layui-anim layui-anim-rl layui-layer-openRight",
              area: "400px",
              zIndex: "99",
              content: ele,
              move: false,
    ...
    var reportTree = tree.render({
      ...
      lockingIcon: ["font_family icon-bukejian", "font_family icon-kejian"], //锁定图标的class
      ...
      template: function (data) {
        ...
        if (data.status == "已完成") {
          str = `
            ...
            <br/>
            <span style="padding-left: 5px;color: #616774">（${data.person}，<span style="color: #45C5B1">${data.status}</span>）</span>
          `;
        } else {
          str = `
            <span>${data.title}</span>
            <br/>
            <span style="padding-left: 5px;color: #616774">（${data.person}，<span>${data.status}</span>）</span>
          `;
        }
        return str;
      },
      lockClick: function (obj) {
        ...
        if (obj.el.hasClass("layui-tree-locking-true")) {
          obj.el
            .removeClass("layui-tree-locking-true")
            .removeClass("icon-bukejian")
            .addClass("layui-tree-locking-false")
            .addClass("icon-kejian");
        } else {
          obj.el
            .removeClass("layui-tree-locking-false")
            .removeClass("icon-kejian")
            .addClass("layui-tree-locking-true")
            .addClass("icon-bukejian");
        }
      },
    });
    ...
    $("#partInfo").on("click", function () {
      var partInfoLayer = $("#partInfoMain");
      layer.open({
        title: "段落信息",
        type: 1,
        anim: -1,
